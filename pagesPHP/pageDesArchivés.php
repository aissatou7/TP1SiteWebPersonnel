...
<body>
  <div class=" container-fluid bg-light mt-5">
    ...
    <div class="row ">
      <h2 class="d-flex justify-content-center p-2 " style="background-color:#2A7282; color:white;">Liste des archivés</h2>
      <div class="col-2">
      ...
      <tbody>
        ...
        if (isset($_POST['recherche']) && ($_POST['recherche'] != '')) { // condition de la recherche
          ...
          // récupérer le nombre d'enregistrements 
                $count=$bdd->prepare("SELECT count(id) as cpt FROM user  WHERE etatArchivage=1 ");
          ...
          //récupérer les enregistrements eux-mêmes
                $stmt=$bdd->prepare("SELECT * FROM user WHERE etatArchivage=1 LIMIT $debut,$nbr_elements_par_page");
